          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="font-poppins text-lg text-[#070708]/40 leading-[160%] text-justify">
                The real estate market in Dubai is highly regulated and one of
                the fastest growing markets where getting a unique and legally
                compliant business name is one of the first steps in
                establishing your presence. Go Kite Business Setup Services is a
                company in Dubai that focuses on Real Estate Name Registration
                Services, making it easier and more confident to navigate the
                legal steps of real estate entrepreneurs and companies.
              </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#3790AE] rounded-xl p-6 space-y-6">
            ...
            <p className="font-poppins text-[15px] text-white leading-relaxed">
              ...
              ensure your license is issued quicklywhile keeping you fully
          ...
          <div className="bg-[#3790AE] rounded-xl p-6 space-y-6">
            ...
            <p className="font-nunito text-[15px] text-white leading-relaxed">
              ...
              activities. Our team handles feasibility studies,environmental
              clearances, and approvals to help you start operations seamlessly.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1440px] mx-auto px-4 md:px-8 pb-20">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center gap-4 md:gap-8 text-white">
            <span className="font-outfit text-[80px] md:text-[147px] font-bold">
              ©
            </span>
            <span className="font-outfit text-[60px] md:text-[234px] font-bold">
              ®
            </span>
            <span className="font-outfit text-[60px] md:text-[90px] font-bold">
              TM
            </span>
            <span className="font-outfit text-[60px] md:text-[90px] font-bold">
              IP
          ...
          <div className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 bg-white rounded-xl p-6 max-w-[569px] border border-[#D7D7D7]">
            <div className="space-y-4">
              ...
              <p className="font-outfit text-[17px] text-[#2E2E2E] leading-relaxed">
                Our team ensures quick and accurate trademark registration so
                your brand identity is protected from unauthorized use.
              </p>
